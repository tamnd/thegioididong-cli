...
// HTTP behaviour is covered in thegioididong_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "thegioididong://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("thegioididong", "about")
	if err != nil || got.String() != "thegioididong://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want thegioididong://page/about", got.String(), err)
	}
}
