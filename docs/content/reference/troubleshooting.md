...
Most of these come down to network reality or how thegioididong serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

thegioididong rate-limits like any public site. thegioididong already paces
...
Where a surface is gated, thegioididong reads a cookie or token you supply
...
`thegioididong`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what thegioididong actually did
