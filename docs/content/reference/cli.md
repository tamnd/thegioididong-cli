...
```
thegioididong <command> [arguments] [flags]
```

Run `thegioididong <command> --help` for the full flag list on any command. This
...
per operation you declare in `thegioididong/domain.go`.
